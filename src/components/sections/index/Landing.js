	...
	return (
		<Container fluid className={LandingStyles.Landingcontainer} >
			<h1>
				...
				<br/>
				<a target="_blank" rel="noreferrer" href="https://github.com/dawichi">			<Github className="animate__animated animate__rollIn"/></a>
				<a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/dawichi/">	<Linkedin className="animate__animated animate__rollIn"/></a>
				<a target="_blank" rel="noreferrer" href="https://twitter.com/dawichi_">			<Twitter className="animate__animated animate__rollIn"/></a>
				<a target="_blank" rel="noreferrer" href="https://www.instagram.com/dawichi_/">	<Instagram className="animate__animated animate__rollIn"/></a>
				<a target="_blank" rel="noreferrer" href="https://twitter.com/dawichi_">			<FileEarmarkPerson className="animate__animated animate__rollIn"/></a>
			</h1>
